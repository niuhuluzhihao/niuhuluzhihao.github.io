...
本人主要进行监督微调相关的工作，所以此处着重说明一下监督微调相关的内容。监督微调中常用的是 Alpaca 格式。
...
* [LLaMA-Factory 数据准备文档](https://llamafactory.readthedocs.io/zh-cn/latest/getting_started/data_preparation.html#openai)
