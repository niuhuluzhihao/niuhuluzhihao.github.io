...
**配置用户名**
git config --global user.name "your_name"                    -----------全局配置,当前项目只需要将global去掉即可
git config --global user.email "your_email@example.com"      ----------全局配置,当前项目只需要将global去掉即可 ,邮箱必须和github账号绑定
...
1、merge和rebase    [https://blog.csdn.net/weixin_42310154/article/details/119004977](https://blog.csdn.net/weixin_42310154/article/details/119004977)
2、git stash apply 和git stash pop   [https://blog.csdn.net/sunhuaqiang1/article/details/118863936](https://blog.csdn.net/sunhuaqiang1/article/details/118863936) ;[https://blog.csdn.net/wangxiuyan0228/article/details/88241787](https://blog.csdn.net/wangxiuyan0228/article/details/88241787)
...
# 同时配置多个github和gitlab账号(win 需要在git bash中运行)
- 配置用户名
